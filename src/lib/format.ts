...
export function teamFlag(code: string | null | undefined): string {
  ...
  const map: Record<string, string> = {
    ...
    FRA: "FR", ESP: "ES", GER: "DE", ITA: "IT", ENG: "GB", POR: "PT", NED: "NL", BEL: "BE", DEN: "DK", SUI: "CH", AUT: "AT", CRO: "HR", SRB: "RS", POL: "PL", SVN: "SI", SCO: "GB", WAL: "GB", UKR: "UA", TUR: "TR", NOR: "NO", SWE: "SE", CZE: "CZ", HUN: "HU", IRL: "IE",
